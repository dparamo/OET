...
<script>
    export default {
        ...
        methods:{
            ...
            axios.post('/propietario', datoNueva)
                .then((res) =>{
            ...
            eliminar(item ,index){
                const confirmacion = confirm(`desea eliminar el usuario: ${item.prop_fnombre}`);
                if (confirmacion) {
                    axios.delete(`/propietario/${item.id}`)
                    .then(()=>{
            ...
            editar(dato){
                ...
                axios.put(`/propietario/${dato.id}`, params)
                    .then(res=>{
                        axios.get('/propietario')
                        .then(res=>{
                            this.datos = res.data.propietario.data
                        })
                    alert('Propietario Editado Correctamente'); 
                    })
                
                
            },
            buscar(){
                axios.get(`/propietarios?prop_cedula=${this.busqueda}`)
                        .then(res=>{
                            this.datos = res.data;
                })
            },
             getpropietario: function(page){

               axios.get('propietario?page='+page)
                .then(res=>{
                this.datos = res.data.propietario.data,
                this.pagination = res.data.paginate
            })
